<%-- 
    Document   : changebalance
    Created on : Oct 27, 2020, 8:09:19 AM
    Author     : Huy
--%>
...
<html lang="en">
    <head>
        <title>E B@nking - Trang Admin - Đổi số dư</title>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    <div class="sidebar">
                        ...
                        <a class="active" href="<c:url value="/admin/changeBalance"/>">Đổi số dư</a>
                    </div>
                </div>
                <div class="mt-md-0 mt-sm-5 mt-4" style="margin: 0 auto;">
                    <h4 class="mb-4 w3f_title title_center">Thay đổi số dư tài khoản</h4>
                    <form action="<c:url value="/admin/findAccount"></c:url>" method="POST">
