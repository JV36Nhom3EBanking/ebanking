<%-- 
    Document   : home
    Created on : Oct 21, 2020, 7:59:36 PM
    Author     : Huy
--%>
...
<html lang="en">
    <head>
        <title>E B@nking - Admin Page</title>
        ...
        <div class="breadcrumb-w3pvt">
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<c:url value="/admin/trangchu"/>">Trang chủ</a></li>
                        <li class="breadcrumb-item" aria-current="page">Xin chào, Admin : ${name}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    <div class="sidebar">
                        <a class="active" href="<c:url value="/admin/trangchu"/>">Trang chủ</a>
                ...
                <div class="mt-md-0 mt-sm-5 mt-4" style="margin: 0 auto;">
                    <h4 class="mb-4 w3f_title">Chào mừng đến với hệ thống E-Banking</h4>
                </div>
            </div>
        </div>
