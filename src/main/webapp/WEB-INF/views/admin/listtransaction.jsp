<%-- 
    ...
    Created on : Oct 26, 2020, 2:25:50 PM
    Author     : Huy
--%>
...
<html lang="en">
    <head>
        <title>E B@nking - Trang Admin - Danh sách giao dịch</title>
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Danh sách giao dịch</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    <div class="sidebar">
                        ...
                        <a class="active" href="<c:url value="/admin/transaction"/>">Xem danh sách giao dịch</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="value" items="${transactions }">
                            <tr>
                                ...
                                <td><a href="<c:url value="/admin/transaction/${value.getId()}"/>">Xem chi tiết</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
