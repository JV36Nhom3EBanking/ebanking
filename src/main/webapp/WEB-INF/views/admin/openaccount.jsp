...
<html lang="en">
    <head>
        <title>E B@nking - Admin Page - Open Account</title>
                            ...
                            <tr>
                                <td colspan="4">
                                    <div style="float: right;">
                                        ...
                                        <form:button type="submit" class="btn btn-default" style="margin-top: 20px; margin-left: 50px; "><a style="color: black;" href="<c:url value="/admin/home"/>">Cancel</a></form:button>
                                    </div>
                                    </td>
                            </form:form>
                        </tr>
