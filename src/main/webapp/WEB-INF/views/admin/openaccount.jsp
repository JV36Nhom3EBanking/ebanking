<%-- 
    ...
    Created on : Oct 26, 2020, 5:14:07 PM
    Author     : Huy
--%>
...
<html lang="en">
    <head>
        <title>E B@nking - Trang Admin - Mở tài khoản</title>
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Mở tài khoản</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    <div class="sidebar">
                        ...
                        <a class="active" href="<c:url value="/admin/openAccount"/>">Mở tài khoản</a>
                        <a href="<c:url value="/admin/changeBalance"/>">Đổi số dư</a>
                    </div>
                </div>
                <div class="mt-md-0 mt-sm-5 mt-4" style="width: 70%; margin: 0 auto;">
                    <h4 class="mb-4 w3f_title title_center">Mở tài khoản mới</h4>
                    <table class="table table-bordered">
                        <form:form name="contactform" method="POST" modelAttribute="openAccountModel" action="/ebanking/admin/confirmopen">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form:input type="text" class="form-control" path="name"
                                                id="name" placeholder="Nhập tên khách hàng" name="name"/>
                                </td>
                            </tr>
                            <tr>
                                <td>Ngày sinh</td>
                                <td>
                                    <form:input type="date" class="form-control" path="birthdate"
                                                id="birthdate" placeholder="Nhập ngày sinh khách hàng" name="birthdate"/>
                                </td>
                            </tr>
                            <tr>
                                <td>CMND</td>
                                <td>
                                    <form:input type="text" class="form-control" path="cmnd"
                                                id="cmnd" placeholder="Nhập cmnd khách hàng" name="cmnd"/>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4" style="background-color: greenyellow;">Thông tin tài khoản : Mở tại chi nhánh</td>
                            </tr>
                            <tr>
                                <td>Quận</td>
                                <td>
                                    <form:select path="district">
                                        <c:forEach items="${district}" var="value">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form:select path="city">
                                        <c:forEach items="${city}" var="value">
                                            <form:option value="${value}">${value}</form:option>
                                        </c:forEach>
                                    </form:select>
                                </td>
                            ...
                            <tr>
                                <td colspan="4">
                                    <div style="float: right;">
                                        <form:button type="submit" class="btn btn-default" style="margin-top: 20px;">Tạo tài khoản</form:button>
                                        <form:button type="submit" class="btn btn-default" style="margin-top: 20px; margin-left: 50px; "><a style="color: black;" href="<c:url value="/admin/trangchu"/>">Hủy bỏ</a></form:button>
                                    </div>
                                    </td>
                            </form:form>
                        </tr>
