<%-- 
    ...
    Created on : Oct 27, 2020, 11:20:11 AM
    Author     : Huy
--%>
...
<html lang="en">
    <head>
        <title>E B@nking - Trang Admin - Đổi số dư thành công</title>
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Thông tin tài khoản đã thay đổi số dư</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="mt-md-0 mt-sm-5 mt-4" style="width: 70%;">
                    <h4 class="mb-4 w3f_title title_center">Thay đổi số dư thành công</h4>
